"""
File containing the more or less scratch of the pure paper.
This was an attempt to train on a paraphrasing data set, but that's not practical.
Training a transformer needs a couple of things
- lots of data
- big architecture
- lots of compute power
Some things I can't practically get.
On top of that, being able to semantically understand a language would be helpful.
"""
